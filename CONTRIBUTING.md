...
These contributions can be made in the form of Issues or [Pull Requests](http://help.github.com/send-pull-requests/) on the [Esi\SimpleTpl repository](https://github.com/ericsizemore/simple_tpl).
...
The following commands can be used to perform the initial checkout of Esi\SimpleTpl:
...
Install Esi\SimpleTpl's dependencies using [Composer](https://getcomposer.org/):
